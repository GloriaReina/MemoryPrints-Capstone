...
namespace MemoryPrints.Utils
{
    public class DbUtils
    {
        ...
        /// <summary>
        ///  Get a bool from a data reader object and gracefully handle NULL values.
        /// </summary>
        ...
        /// <returns>The value of the given column or false if NULL.</returns>
